...
class GeminiService:
    ...
    def disease_assessment(self, disease: set):
        ...
        prompt =""" 
            ...
            Risk of exposure measures how likely a typical short to medium term traveler is to be exposed during ordinary travel, considering common movement through airports, transport routes, urban areas, regional towns, and sometimes semi-urban or rural settings depending on itinerary.
            0 = Unknown
            1 = Low: relatively unlikely exposure for a typical traveler
            2 = Medium: plausible exposure under normal travel behavior
            3 = High: relatively likely exposure due to common transmission routes, crowd contact, environmental exposure, or active circulation

            Confidence measures how certain the severity and risk-of-exposure assessments are based on the available information and general authoritative medical/public health knowledge. You must
            Use 3 only when the disease characteristics and traveler exposure profile are well-established and the assessment is straightforward.
            Use 2 when the assessment is generally reasonable but some uncertainty remains.
            Use 1 when the disease name is ambiguous, uncommon, context-dependent, or the assessment depends heavily on missing details.
