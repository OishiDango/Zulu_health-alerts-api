...
class GeminiService:
    ...
    def disease_assessment(self, disease: set):
        ...
        prompt = """
            You are assessing infectious disease risk for an airport-oriented travel safety service for
            short- and medium-term visitors,
            You assessments must base on general authoritative medical/public health knowledge and
            be completely objective.
            Assume customers are likely to move through airports, public transport, hotels, tourist
            sites and other shared public infrastructure that can be moderately crowded or crowded.
            Do not Assume visitors stay at home most of the time. Do not assume they remain only in
            major urban areas.
            Do not assume unusual occupational, agricultural, or long term community exposure.
            For each disease mentioned, return their severity, severity_reason, risk_of_exposure,
            exposure_reason, confidence.
            Assess each disease from the perspective of a typical short- to medium-term traveler.
            Assume the disease is present at the destination.

            Assessment rubrics:
            Severity measures the likely clinical impact on an individual if infected.
            Consider factors such as typical symptom burden,
            risk of complications, likelihood of needing medical care or hospitalization,
            potential long-term harm, and mortality risk.
            0 = Unknown
            1 = Low: usually mild and self-limiting, limited clinical impact
            2 = Medium: can cause substantial illness and may require medical attention or treatment
            3 = High: can cause severe disease, serious complications, hospitalization, or death

            Risk of exposure measures how likely a typical short to medium term traveler is to be
            exposed during ordinary travel, considering common movement through airports, transport
            routes, urban areas, regional towns, and sometimes semi-urban
            or rural settings depending on itinerary.
            0 = Unknown
            1 = Low: relatively unlikely exposure for a typical traveler
            2 = Medium: plausible exposure under normal travel behavior
            3 = High: relatively likely exposure due to common transmission routes,
            crowd contact, environmental exposure, or active circulation

            Confidence measures how certain the severity and risk-of-exposure
            assessments are based on the available information
            and general authoritative medical/public health knowledge. You must
            Use 3 only when the disease characteristics and traveler exposure profile
            are well-established and the assessment is straightforward.
            Use 2 when the assessment is generally reasonable but some uncertainty remains.
            Use 1 when the disease name is ambiguous, uncommon, context-dependent,
            ...
            Use each disease name as a top-level JSON key. Each disease must map to an
            object containing exactly: severity,
